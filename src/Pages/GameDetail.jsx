                ...
                <>
                    <div className="h-[30vh] relative">
                        ...
                        <div className="absolute top-0 left- w-full h-full flex justify-center items-center flex-col">
                            <h1 className="md:text-7xl text-3xl font-black text-white text-normal text-shadow-lg/70 text-shadow-black">{game.name} {!isOld(game.released) && <span className="badge bg-[yellow] text-black text-normal font-bold italic p-1 rounded-sm text-lg text-shadow-none">New</span>}</h1>
                        </div>
                    </div>
                    <div className="flex w-full my-10 md:px-40 px-5 gap-10 md:flex-row flex-col">
                        <div className="md:w-2/3 w-full flex flex-col md:order-0 order-1">
                            <div className="flex justify-between items-center w-full mb-10 md:flex-row flex-col md:gap-0 gap-10">
                                <FavoriteBtn id={game.id} />
                                {game.website && game.website !== "" && <WebsiteBtn website={game.website} />}
                                
                            </div>
                            <p className="text-normal md:text-start text-center text-3xl font-black highlight uppercase pb-5">Informazioni</p>
                            <div className="flex w-full detail-card rounded-xl md:flex-row flex-col">
                            ...
                            <p className="text-normal md:text-start text-center text-3xl font-black highlight uppercase pb-5 mt-10">Valutazione</p>
                            ...
                            <p className="text-normal md:text-start text-center text-3xl font-black highlight uppercase pb-5">Descrizione</p>
                        ...
                        <div className="md:w-1/3 w-full md:order-1 order-0">
                            <DetailSwiper id={id}/>
                            <DetailVideo id={id} />
                        </div>
                    </div>
