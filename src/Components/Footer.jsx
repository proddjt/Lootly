...
function Footer(){
    return (
        <footer className="bg-black rounded-lg shadow-sm mt-4 mb-2 text-[yellow]">
            <div className="w-full mx-auto max-w-screen-xl p-4 flex md:items-center md:justify-between md:gap-0 gap-5 md:flex-row flex-col">
                <span className="text-sm text-center">Developed by Giovanni Tramontano. © 2025. All Rights Reserved.</span>
                <ul className="flex flex-wrap items-center md:justify-start justify-center mt-3 text-sm font-medium sm:mt-0">
                    <li>
