    ...
    return (
        <div className="dropdown dropdown-end">
            ...
            className="menu menu-md dropdown-content bg-base-100 rounded-box z-1 mt-3 w-52 p-2 shadow text-[yellow]">
                ...
                <button className="text-start"><li className="py-1 font-semibold bg-neutral-700 hover:bg-neutral-500"><p><RiLogoutBoxLine className="inline text-2xl"/>Logout</p></li></button>
            </ul>
        </div>
    )
}
