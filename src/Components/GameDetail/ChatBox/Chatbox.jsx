...
function ChatBox({game}){
                ...
                .insert([
                    {
                        ...
                        profile_username: session?.user.user_metdata.username,
                        game_id: game.id,
                        content: message
                    }
                ])
    ...
    return (
        ...
        <div className="fixed bottom-10 right-4 z-50">
            ...
            {isOpen && (
                <div className="mt-2 w-80 h-96 bg-neutral-800 rounded-xl shadow-xl border-2 border-black flex flex-col overflow-hidden">
